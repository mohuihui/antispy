...
Routine Description:
  read a record from the mft. The read mft record is mst deprotected and is hence
  ready to use. The caller should check the record with is_baad_record() in case 
  mst deprotection failed. 
