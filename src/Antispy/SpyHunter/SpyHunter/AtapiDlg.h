...
class CAtapiDlg : public CDialog
{
	DECLARE_EASYSIZE
	DECLARE_DYNAMIC(CAtapiDlg)

public:
	CAtapiDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CAtapiDlg();

// 对话框数据
	enum { IDD = IDD_ATAPI_DIALOG };
...
public:
	...
	void InsertStartIoDispatch(DISPATCH_HOOK_INFO HookInfo);
};
