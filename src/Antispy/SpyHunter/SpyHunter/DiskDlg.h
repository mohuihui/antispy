...
public:
	CDiskDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDiskDlg();
...
public:
	...
	CString m_szStatus;
	vector<DISPATCH_HOOK_INFO> m_ClasspnpHookVector;
	...
	void GetClasspnpDispatch();
	void InsertClasspnpItem(DISPATCH_HOOK_INFO HookInfo);
